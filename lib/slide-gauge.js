...
;(function () {
  ...
  root.innerHTML =
    '<button type="button" class="sg-fab" title="滑动测量仪" aria-label="打开滑动测量仪">测</button>' +
    '<div class="sg-panel" hidden>' +
    '  <div class="sg-titlebar">' +
    '    <span class="sg-title">滑动测量仪</span>' +
  ...
  function drawCly(c) {
    ...
    if (im && im.complete && im.naturalWidth > 0) {
      ...
      c.textAlign = 'center'
      c.fillText('滑动测量仪', init.cly.cx, y + 100)
      c.restore()
    }
  }
